--Versão do banco de dados: 20210405
...
--Dropando a base
drop table alunov cascade;
drop table seq_salario_registro cascade;
drop table seq_funcionario cascade;
drop table discip cascade;
drop table cursa cascade;
drop table aluno_pos cascade;
drop table aluno_grad cascade;
drop table devedor cascade;
drop table depositante cascade;
drop table conta cascade;
drop table emprestimo cascade;
drop table clientecor cascade;
drop table agencia  cascade;
drop table item_pedido cascade;
