-- 01 - Encontre a média dos preços de venda dos produtos que terminem com a letra 'o'. Arredonde para duas casas decimais.

SELECT round(avg(valor_venda),2)
from produto
where descricao like '%o';

-- 02 - Encontre a média das horas-aulas de todas as turmas. Trunque com duas casas decimais. Coloque alias de ”Média dos Valores das Horas/Aulas”.

select trunc(avg(tur_precohoratur),2) as "Média dos Valores das Horas/Aulas"
from turma;

-- 03 - Encontre o curso mais caro e o mais barato. Use as 
...
-- 04 - Mostre a quantidade de alunos cadastrados no sistema.

select count(*)
from aluno;

-- 05 - Encontre: 1 - A soma da quantidade de produtos, por meio da função sum na 
...
-- 06 - Faça uma consulta para um relatório que retorne as 
...
-- 07 - Paulo Afonso precisa de um relatório que contenha o código do 
...
-- 08 - Encontre a soma dos salários dos vendedores agrupados por faixa de comissão. Mas só mostre as faixas cuja a soma seja igual ou maior que 6000.
